...
function UploadArea({ pubkey }: { pubkey: string | null }) {
  ...
  return (
    <form onSubmit={submit} aria-disabled={!pubkey}
      className={`bg-card border border-border p-3 space-y-2 transition-opacity duration-300 ${pubkey ? '' : 'opacity-50 pointer-events-none'}`}>
      ...
      <div className="flex items-center justify-end gap-3 pt-0.5">
        ...
        <button type="submit" disabled={!canSubmit || busy || !pubkey}
